...
import com.planktonfly.linguasurf.components.LinguaSurfRecommendedAddonsProvider
...
class Components(private val context: Context) {
    ...
    val addonsProvider: AddonsProvider by lazyMonitored {
        LinguaSurfRecommendedAddonsProvider()
    }

    fun clearAddonCache() {
        // No-op: LinguaSurf uses a local recommended add-ons provider.
    }
