...
class OnboardingFragment : Fragment() {
    ...
    // Keep these onboarding templates in Nimbus config, but suppress showing them for now.
    private val suppressedOnboardingCards = setOf(
    ...
    private val pagesToDisplay by lazy {
        with(requireContext()) {
            ...
            ).filterNot { it.type in suppressedOnboardingCards }.toMutableList()
        }
    }
